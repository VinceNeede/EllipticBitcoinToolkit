...
class TestTemporalSplit:
    ...
    def test_torch_temporal_split(self):
        ...
        if torch.cuda.is_available():
            ...
            train_idx_cuda, test_idx_cuda = temporal_split(
                times_cuda, test_size=self._test_size)
    ...
    def test_dataframe_no_return_xy(self):
        ...
        train_df, test_df = temporal_split(
            df, test_size=self._test_size, return_X_y=False)
